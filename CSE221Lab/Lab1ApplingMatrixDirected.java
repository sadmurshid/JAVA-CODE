...
class Lab1ApplingMatrixDirected
{
  static int [][] mat;
...
//      System.out.println(st[0]+" "+st[1]);
      mat[fn-1][sn-1]=1;                                         //Making edge between nodes
//      mat[sn-1][fn-1]=1;                                       //Making edge between nodes
    }
...
//        System.out.println(i+1+" "+(j+1));
        if(mat[i][j]==1)
          System.out.print((j+1)+" ");                           //Print if two node have an edge
      }
      System.out.println();
    }
  }
